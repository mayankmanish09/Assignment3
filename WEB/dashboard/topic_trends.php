...
$topic = "cover up";
$res = mysql_query("select * from topic_temp where Topic like '%".$topic."%'");//getting data fot the input topic
$rows = mysql_num_rows($res);
$columns = mysql_num_fields($res);

//datatable feeds the table into the google charts
...
while($rows = mysql_fetch_row($res)){
	...
	if($date_prev[2] == $date[2]){
		...
		$prev = $rows;//spliting the date string to convert it into data recognisable by google charts
		}else{
...
<form action="topic_trends2.php" method="post">
<input name="t1" type="text"/>
<input type="submit" name="s1" value="Get Topic Trends" class="btn btn-navy"/>
</form>
     ...
     <!-------------------------------------------date picking ending---------------------------------------->                
                    ...
                    <br/>
                    <br/>
                	Interaction based on topics: Cover up
                    </h2>
					<div class="block">
