...
$res = mysql_query("select * from daily_logs"); //query for the daily data

if($_REQUEST['s1'] && $_REQUEST['from'] != NULL){//request for the date boundaries
$date1 = $_REQUEST['from'];
$date2 = $_REQUEST['to'];
$date1_row = explode("/", $date1);
$date2_row = explode("/", $date2);
$date1 = $date1_row[2]."-".$date1_row[0]."-".$date1_row[1];
$date2 = $date2_row[2]."-".$date2_row[0]."-".$date2_row[1];
$res = mysql_query("select * from daily_logs where Time >= '".$date1."' and Time <= '".$date2."'");
...
//datatable contains the string that would act as input for the google charts
